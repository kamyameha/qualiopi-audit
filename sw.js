const CACHE='entre-deux-qualiopi-secours-v2';
const SECOURS=['./','./index.html','./css/main.css','./css/site-alignment.css','./js/app.js','./js/version.js','./data/qualiopi.json','./assets/logo-entre-deux.png'];
