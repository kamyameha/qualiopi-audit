const CACHE='entre-deux-qualiopi-secours-v13';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.3','./css/site-alignment.css?v=1.0.3','./css/audit-ui.css?v=1.0.3','./js/app.js?v=1.0.3','./js/version.js?v=1.0.3','./js/supabase-config.js','./js/supabase-service.js?v=1.0.3','./data/qualiopi.json','./assets/logo-entre-deux.png'];
