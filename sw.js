const CACHE='entre-deux-qualiopi-secours-v20';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.10','./css/site-alignment.css?v=1.0.10','./css/audit-ui.css?v=1.0.10','./js/app.js?v=1.0.10','./js/version.js?v=1.0.10','./js/supabase-config.js','./js/supabase-service.js?v=1.0.10','./data/qualiopi.json','./assets/logo-entre-deux.png'];
