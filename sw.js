const CACHE='entre-deux-qualiopi-secours-v17';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.7','./css/site-alignment.css?v=1.0.7','./css/audit-ui.css?v=1.0.7','./js/app.js?v=1.0.7','./js/version.js?v=1.0.7','./js/supabase-config.js','./js/supabase-service.js?v=1.0.7','./data/qualiopi.json','./assets/logo-entre-deux.png'];
