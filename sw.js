const CACHE='entre-deux-qualiopi-secours-v16';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.6','./css/site-alignment.css?v=1.0.6','./css/audit-ui.css?v=1.0.6','./js/app.js?v=1.0.6','./js/version.js?v=1.0.6','./js/supabase-config.js','./js/supabase-service.js?v=1.0.6','./data/qualiopi.json','./assets/logo-entre-deux.png'];
