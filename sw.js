const CACHE='entre-deux-qualiopi-secours-v18';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.8','./css/site-alignment.css?v=1.0.8','./css/audit-ui.css?v=1.0.8','./js/app.js?v=1.0.8','./js/version.js?v=1.0.8','./js/supabase-config.js','./js/supabase-service.js?v=1.0.8','./data/qualiopi.json','./assets/logo-entre-deux.png'];
