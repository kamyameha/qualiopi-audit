const CACHE='entre-deux-qualiopi-secours-v15';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.5','./css/site-alignment.css?v=1.0.5','./css/audit-ui.css?v=1.0.5','./js/app.js?v=1.0.5','./js/version.js?v=1.0.5','./js/supabase-config.js','./js/supabase-service.js?v=1.0.5','./data/qualiopi.json','./assets/logo-entre-deux.png'];
