const CACHE='entre-deux-qualiopi-secours-v12';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.2','./css/site-alignment.css?v=1.0.2','./css/audit-ui.css?v=1.0.2','./js/app.js?v=1.0.2','./js/version.js?v=1.0.2','./js/supabase-config.js','./js/supabase-service.js?v=1.0.2','./data/qualiopi.json','./assets/logo-entre-deux.png'];
