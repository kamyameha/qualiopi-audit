const CACHE='entre-deux-qualiopi-secours-v14';
const SECOURS=['./','./index.html','./css/main.css?v=1.0.4','./css/site-alignment.css?v=1.0.4','./css/audit-ui.css?v=1.0.4','./js/app.js?v=1.0.4','./js/version.js?v=1.0.4','./js/supabase-config.js','./js/supabase-service.js?v=1.0.4','./data/qualiopi.json','./assets/logo-entre-deux.png'];
